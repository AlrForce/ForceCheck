...
PYFILES="__init__.py ansinfo.py bgp.py bot.py checkall.py cli.py colors.py _deps.py http.py ping.py tcp.py trace.py whois.py"
...
printf "  ║%s║\n" "$(printf '%-*s' $W "  Run 'fcheck' to open the menu")"
printf "  ║%s║\n" "$(printf '%-*s' $W "  Run 'bot!'   to start the Telegram bot")"
printf "  ╚%s╝\n" "$(printf '═%.0s' $(seq 1 $W))"
printf "${N}\n"
